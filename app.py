...
# =========================================================
# 2. INJEÇÃO DE CSS GLOBAL E CONTROLE DE EXIBIÇÃO INSTANTÂNEA
# =========================================================
st.markdown(f"""
    <style>
    /* MODO ESCURO FORÇADO */
    ...
    /* MANTÉM VISÍVEL APENAS A VIEW ATIVA SEM RECARREGAR O FRONT-END */
    div[data-testid="stElementContainer"]:has(> div.st-key-view_inicio) {{
        display: {"block" if aba_ativa == "inicio" else "none"} !important;
    }}
    div[data-testid="stElementContainer"]:has(> div.st-key-view_pesagem) {{
        display: {"block" if aba_ativa == "pesagem" else "none"} !important;
    }}
    div[data-testid="stElementContainer"]:has(> div.st-key-view_historico) {{
        display: {"block" if aba_ativa == "historico" else "none"} !important;
    }}
    div[data-testid="stElementContainer"]:has(> div.st-key-view_config) {{
        display: {"block" if aba_ativa == "config" else "none"} !important;
    }}
    </style>
...
# =========================================================
# 5. RODAPÉ FIXO (CÁPSULA) DENTRO DO ECOSSISTEMA STREAMLIT
# =========================================================
if st.session_state["usuario_logado"]:
