...
# =========================================================
# 2. INJEÇÃO DE CSS (MODO ESCURO + ESTRUTURA ORIGINAL DO RADIO)
# =========================================================
st.markdown("""
    <style>
    ...
    /* =========================================================
       TRAVA DO MENU RADIO NO RODAPÉ (80PX FIXO A 360PX)
       ========================================================= */
    ...
    /* Oculta a bolinha do radio nativo */
    ...
    /* CLASSES PARA NAVEGAÇÃO INSTANTÂNEA EM TELA */
    .tab-view-container {
        display: none;
    }
...
# =========================================================
# 5. OS 4 MENUS DE NAVEGAÇÃO (ESTRUTURA ORIGINAL)
# =========================================================
opcoes_menu = ["Início", "Formulário", "Painel", "⚙️ Config"]
aba = st.session_state["aba_ativa"]
idx_atual = opcoes_menu.index(aba) if aba in opcoes_menu else 0
...
# =========================================================
# 6. CONTEÚDO RENDERIZADO (TROCA INSTANTÂNEA)
# =========================================================

# --- ABA 1: INÍCIO ---
st.markdown("<div id='view-inicio' class='tab-view-container " + ("active-view" if aba == "Início" else "") + "'>", unsafe_allow_html=True)
...
# --- ABA 2: FORMULÁRIO ---
st.markdown("<div id='view-pesagem' class='tab-view-container " + ("active-view" if aba == "Formulário" else "") + "'>", unsafe_allow_html=True)
...
# --- ABA 3: PAINEL ---
st.markdown("<div id='view-historico' class='tab-view-container " + ("active-view" if aba == "Painel" else "") + "'>", unsafe_allow_html=True)
...
# --- ABA 4: CONFIGURAÇÕES ---
st.markdown("<div id='view-config' class='tab-view-container " + ("active-view" if aba == "⚙️ Config" else "") + "'>", unsafe_allow_html=True)
